...
const YouInSportsPostCard = ({ post, index, isPuzzleGrid = false, onClick }) => {
    ...
    return (
        <motion.div
            ...
            onClick={onClick}
            className="group relative flex flex-col bg-surface border border-white/5 rounded-2xl overflow-hidden hover:border-white/10 transition-all duration-300 hover:shadow-xl cursor-pointer"
        >
            {/* Post Image */}
